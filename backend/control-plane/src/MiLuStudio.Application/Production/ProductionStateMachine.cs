...
internal sealed class ProductionStateMachine
{
    ...
    internal static IReadOnlyDictionary<ProductionStage, IReadOnlySet<ProductionStage>> LegalTransitions { get; } =
        new Dictionary<ProductionStage, IReadOnlySet<ProductionStage>>
        {
            ...
            [ProductionStage.StoryIngesting] = new HashSet<ProductionStage> { ProductionStage.ScriptReadyForReview, ProductionStage.FailedRetryable },
            ...
            [ProductionStage.StoryboardReadyForReview] = new HashSet<ProductionStage> { ProductionStage.ImagesReadyForReview, ProductionStage.FailedRetryable },
            [ProductionStage.ImagesReadyForReview] = new HashSet<ProductionStage> { ProductionStage.VideosReadyForReview, ProductionStage.FailedNeedsUser },
            [ProductionStage.VideosReadyForReview] = new HashSet<ProductionStage> { ProductionStage.Exporting, ProductionStage.FailedNeedsUser },
